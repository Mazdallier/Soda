package com.slymask3.soda.command;
...
public class CommandSoda extends CommandBase {
    ...
    public List getCommandAliases() {
        return Arrays.asList(new String[] {"sodamod"});
    }
...
//         	}
    ...
    public void list1(EntityPlayer player) {
    	...
    	player.addChatMessage(new ChatComponentText("\u00a73\u00a7l"+Reference.MOD_NAME+" v" + Reference.VERSION + " - Command List - Page 1/2")); //2
...
//    	player.addChatMessage(new ChatComponentText("\u00a72/ib simpleMode [true/false] \u00a7a- Simple water/lava creation.")); //9
    ...
    public void list2(EntityPlayer player) {
		player.addChatMessage(new ChatComponentText("\u00a78\u00a7l=============================================")); //1
    	player.addChatMessage(new ChatComponentText("\u00a73\u00a7l"+Reference.MOD_NAME+" v" + Reference.VERSION + " - Command List - Page 2/2")); //2
...
//    	player.addChatMessage(new ChatComponentText("\u00a72/ib colorblock \u00a7a- Sets the texture of color block to held block texture.")); //3
	...
	public void info(EntityPlayer player) {
    	...
    	player.addChatMessage(new ChatComponentText("\u00a73\u00a7l"+Reference.MOD_NAME+" v" + Reference.VERSION + " - Info"));
...
//    	}
	...
	public void changelog(EntityPlayer player) {
		...
		player.addChatMessage(new ChatComponentText("\u00a72- Mod created."));
		player.addChatMessage(new ChatComponentText("\u00a78\u00a7l============================================="));
	}
