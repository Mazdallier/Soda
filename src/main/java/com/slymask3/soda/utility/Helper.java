package com.slymask3.soda.utility;
...
public class Helper {
	public static void msgClean(EntityPlayer player, String msg, String color) {
		//if (ConfigurationHandler.msg == true) {
			player.addChatMessage(new ChatComponentText("\u00a78[\u00a73"+Reference.MOD_NAME+" v" + Reference.VERSION + "\u00a78] " + ColorHelper.colorEveryWord(msg, color)));
		//}
	}
	...
	public void tp(World world, EntityPlayer player, int x, int y, int z, boolean property) {
		if (!world.isRemote) { //IF SERVER
			if (property) {
				//Helper.sound(world, ConfigurationHandler.sound, x, y, z);
